...
# ============================
GRP_LNK = environ.get('GRP_LNK', 'https://t.me/BookClubLKChat') # Group link for the bot
OWNER_LNK = environ.get('OWNER_LNK', 'https://t.me/Lakshitha117') # Owner link for the bot
UPDATE_CHNL_LNK = environ.get('UPDATE_CHNL_LNK', 'https://t.me/BookClubLK') # Update channel link for the bot
...
DELETE_TIME = int(environ.get("DELETE_TIME", "1000"))  #  deletion time in seconds (default: 5 minutes). Adjust as per your needs.
...
# If set, the auto-filter search in groups will only respond inside this forum topic
# (message_thread_id). Leave unset/0 to respond in all topics/messages as before.
SEARCH_TOPIC_ID = int(environ.get('SEARCH_TOPIC_ID', '0')) or None
